...
////some more validaion
 ...
 (select count(fleet) from  bookinglog where department ='$department' and  bookinglog.status = 'Approved' ) countDept
                ...
                if(mysqli_num_rows($resultForD)) 
                    {	
                        ...
                        while($rowForD= mysqli_fetch_assoc($resultForD)) 
                        {
                            ...
                            {
                                echo ("Your departmental booking has reached maximum for today.");
                                     exit;
                            }
                        }
                    }
