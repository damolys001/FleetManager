<?php
include_once "connect_db_link.php";

echo "<h1>Success in database CONNECTION.....</h1><br/>";

$googleTable ="CREATE TABLE IF NOT EXISTS `google_users` (
...
nameo varchar (255) DEFAULT NULL,
email varchar (255) DEFAULT NULL,
passHash varchar (255) DEFAULT NULL,
passSalt varchar (255) DEFAULT NULL,
role varchar (255) DEFAULT '4',
location varchar (255) DEFAULT NULL,
sex varchar (255) DEFAULT NULL,
department varchar (255) DEFAULT NULL,
detail text (10000) DEFAULT NULL,
...
approver3  varchar (255) DEFAULT NULL,
status varchar (255) DEFAULT NULL,
position varchar (255) DEFAULT NULL,

firstTime  varchar (255) DEFAULT '0',
...
maxPerDept varchar (255) DEFAULT NULL,
...
$fleetStatus ="CREATE TABLE IF NOT EXISTS  fleetStatus (
id int(11) NOT NULL auto_increment,
fleetStatus varchar (255) DEFAULT NULL,
description varchar (255) DEFAULT NULL,
detail text (1000) DEFAULT NULL,
time_created timestamp,
updated varchar (255) DEFAULT NULL,
...
$driverStatus ="CREATE TABLE IF NOT EXISTS  driverStatus (
id int(11) NOT NULL auto_increment,
...
$upload ="CREATE TABLE IF NOT EXISTS  upload (
id int(11) NOT NULL auto_increment,
...
$fleetHistory ="CREATE TABLE IF NOT EXISTS  fleetHistory (
id int(11) NOT NULL auto_increment,
...
driversLicenseNo varchar (255) DEFAULT NULL,
empDate varchar (255) DEFAULT NULL,
location varchar (255) DEFAULT NULL,
PhoneNo varchar (255) DEFAULT NULL,
PhoneNo2 varchar (255) DEFAULT NULL,
PhoneNo3 varchar (255) DEFAULT NULL,
...
$driverHistory ="CREATE TABLE IF NOT EXISTS  driverHistory (
id int(11) NOT NULL auto_increment,
...
$bookinglog ="CREATE TABLE IF NOT EXISTS  bookinglog (
id int(11) NOT NULL auto_increment,
...
createdForD varchar (255) DEFAULT NULL,
createdInterStateD varchar (255) DEFAULT NULL,
...
extensionBy varchar (255) DEFAULT NULL,
extensionStart varchar (255) DEFAULT NULL,
extensionEnd varchar (255) DEFAULT NULL,
...
$mycomment ="CREATE TABLE IF NOT EXISTS  mycomment (
id int(11) NOT NULL auto_increment,
...
$myRating ="CREATE TABLE IF NOT EXISTS  myRating (
id int(11) NOT NULL auto_increment,

referenceid varchar (255) DEFAULT NULL,
cmtype varchar (255) DEFAULT NULL,
driver float DEFAULT NULL,
fleet float DEFAULT NULL,

driverId float DEFAULT NULL,
fleetId float DEFAULT NULL,
...
$shop_basic = "CREATE TABLE IF NOT EXISTS shop_basic (
id int(11) NOT NULL auto_increment,
name varchar (255) DEFAULT NULL,
shopDomain varchar (255) DEFAULT NULL,
cutomer_email varchar (255) DEFAULT NULL,
...
weightDefault varchar (255) DEFAULT NULL,
currency varchar (255) DEFAULT NULL,
currencySymbol varchar (255) DEFAULT NULL,
prifix varchar (255) DEFAULT NULL,
sufix varchar (255) DEFAULT NULL,

mailClient  varchar (255) DEFAULT NULL,
mailClientId  varchar (255) DEFAULT NULL,

mailClientCust  varchar (255) DEFAULT NULL,
mailClientIdCust  varchar (255) DEFAULT NULL,


bookingStart varchar (255) DEFAULT NULL,
bookingEnd  varchar (255) DEFAULT NULL,
maxHour  varchar (255) DEFAULT NULL,
maxPerDept  varchar (255) DEFAULT NULL,
...
$shop_ExtMailClient = "CREATE TABLE IF NOT  EXISTS shop_ExtMailClient (
id int(11) NOT NULL auto_increment,
...
SHOP_Id int,
PRIMARY KEY (id),
FOREIGN KEY (SHOP_Id) REFERENCES shop_basic(Id)
)
;";


$carModelPre ="CREATE TABLE IF NOT  EXISTS fleetmodelYearPre (
	`id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
	`year` INT(4) UNSIGNED NOT  NULL,
	`make` VARCHAR(50) default  NULL,
	`fleetmodel` VARCHAR(50) NOT NULL,
...
detail text (10000) DEFAULT NULL,
	...
	PRIMARY KEY (`id`),
	UNIQUE `U_VehicleModelYear_year_make_model` (`year`,`make`, `fleetmodel`),
	INDEX `I_VehicleModelYear_year` (`year`),
	INDEX `I_VehicleModelYear_make` (`make`),
	INDEX `I_VehicleModelYear_model` (`fleetmodel`)
) ;";


$carModel ="CREATE TABLE IF NOT  EXISTS fleetmodel (
	`id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
detail text (10000) DEFAULT NULL,
	...
	PRIMARY KEY (`id`),
	UNIQUE `U_VehicleModelYear_year_make_model` (`make`, `fleetmodel`),
...
$carMake ="CREATE TABLE IF NOT  EXISTS `fleetmake` (
	`id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
	`fleetmake` VARCHAR(50) NOT NULL,
...
detail text (10000) DEFAULT NULL,
	...
	PRIMARY KEY (`id`),
    UNIQUE `U_Vfleet_make_model` ( `fleetmake`),
	INDEX `I_Vehiclefleet_make` (`fleetmake`)
...
$chatlog ="CREATE TABLE IF NOT EXISTS  chatlog (
id int(11) NOT NULL auto_increment,
...
//inser user into user tables
	$adminPass = sha1 ('Ensure123');
	$adminPassSalt = sha1 ('ensurefleet_Ensure123');
$adminInsert = "INSERT INTO `user` (
 `id`,  `email`, `namel`, `namef`, `passHash`,`passSalt`, `role`, `status`, `created`
  ) 
  VALUES 
  (NULL,
  'ensurefleet', 
...
////insert into User
$insertEnsureUser ="
insert into user (email, namef,namel,nameo,department,approver1, approver2,position)
values 
('owolabi.salami@ensure.com.ng', 'OWOLABI', 'SALAMI', '', '1', '1', '0', 'CHIEF RESPONSIBILITY OFFICER'),
('Abimbola.Alabi@ensure.com.ng', 'ABIMBOLA', 'ALABI', '', '2', '2', '0', 'DEPUTY MANAGER'),
('erezi.ogubere@ensure.com.ng', 'EREZI', 'OGUBERE', '', '2', '2', '0', 'EXECUTIVE OFFICER'),
('uyi.osagie@ensure.com.ng', 'UYI', 'OSAGIE', '', '3', '4', '4', 'SENIOR MANAGER'),
('monday.gabriel@ensure.com.ng', 'MONDAY', 'GABRIEL', '', '3', '4', '4', 'EXECUTIVE OFFICER'),
('ayobami.bankole@ensure.com.ng', 'AYOBAMI', 'BANKOLE', '', '3', '4', '4', 'ASSISTANT EXECUTIVE OFFICER'),
('uche.onodu@ensure.com.ng', 'UCHENNA', 'ONODU', '', '3', '4', '4', 'ASSISTANT EXECUTIVE OFFICER'),
('tosin.olawunmi@ensure.com.ng', 'OLUWATOSIN', 'TREASURE - OLAWUNMI', '', '3', '4', '4', 'EXECUTIVE TRAINEE'),
('dotun.olowonyo@ensure.com.ng', 'OLUDOTUN', 'OLOWONYO', '', '4', '9', '4', 'DEPUTY MANAGER'),
('progress.ovbije@ensure.com.ng', 'OVBIJE', 'PROGRESS', 'IJEOMA', '4', '9', '4', 'ASSISTANT EXECUTIVE OFFICER'),
('hammed.salawu@ensure.com.ng', 'HAMMED', 'SALAWU', 'OLATUNJI', '4', '9', '4', 'EXECUTIVE TRAINEE'),
('perpetual.ike@ensure.com.ng', 'PERPETUAL', 'CHINONSO', 'IKE', '4', '9', '4', 'EXECUTIVE TRAINEE'),
('moji.alimi@ensure.com.ng', 'MOJISOLA', 'ALIMI', '', '5', '13', '4', 'ASSISTANT EXECUTIVE OFFICER'),
('adesuwa.goodey@ensure.com.ng', 'ADESUWA', 'GOODEY', '', '5', '13', '4', 'EXECUTIVE TRAINEE'),
('fatai.afolawiyo@ensure.com.ng', 'AYINDE', 'FATAI', '', '5', '13', '4', 'CONTRACT'),
('emmanuel.mishael@ensure.com.ng', 'EMMANUEL', 'MISHAEL', '', '5', '13', '4', 'CONTRACT'),
('olumide.mala@ensure.com.ng', 'OLUMIDE', 'MALA', '', '5', '13', '4', 'CONTRACT'),
('oloyede.ogundipe@ensure.com.ng', 'OLOYEDE', 'OGUNDIPE', '', '5', '13', '4', 'CONTRACT'),
('tunde.mimiko@ensure.com.ng', 'BABATUNDE', 'MIMIKO', '', '6', '19', '19', 'ASSISTANT GENERAL MANAGER'),
('folake.akhile@ensure.com.ng', 'NWANKPELE', 'FOLAKE', 'MATILDA', '7', '20', '19', 'DEPUTY MANAGER(UNIT HEAD)'),
('kingsley.oboh@ensure.com.ng', 'KINGSLEY', 'OBOH', '', '7', '20', '19', 'SENIOR EXECUTIVE OFFICER'),
('dami.immanuel@ensure.com.ng', 'IMMANUEL', 'DAMILOLA', 'ISAIAH', '7', '20', '19', 'EXECUTIVE TRAINEE'),
('pelumi.omolua@ensure.com.ng', 'OLUWAPELUMI', 'OMOLUA', '', '7', '20', '19', 'EXECUTIVE TRAINEE'),
('sylvia.nwachukwu@ensure.com.ng', 'NWACHUKWU', 'UGOCHI', 'SYLVIA', '8', '24', '19', 'DEPUTY MANAGER (UNIT HEAD)'),
('joy.odere@ensure.com.ng', 'ODERE', 'JOY', '', '8', '24', '19', 'EXECUTIVE OFFICER'),
('tunde.ladele@ensure.com.ng', 'BABATUNDE', 'LADELE', '', '8', '24', '19', 'ASSISTANT EXECUTIVE OFFICER'),
('micah.michael@ensure.com.ng', 'MICHAEL', 'MICAH', 'ITUNU', '8', '24', '19', 'EXECUTIVE TRAINEE'),
('femi.gbolarumi@ensure.com.ng', 'OLUWAFEMI', 'GBOLARUMI', '', '9', '28', '19', 'ASSISTANT MANAGER (UNIT HEAD)'),
('sade.akande@ensure.com.ng', 'FOLUSADE', 'AKANDE', '', '9', '28', '19', 'ASSISTANT EXECUTIVE OFFICER'),
('nnamdi.etonyeaku@ensure.com.ng', 'ETONYEAKU', 'NNAMDI', 'ALEXANDER', '9', '28', '19', 'ASSISTANT EXECUTIVE OFFICER'),
('moyo.awopegba@ensure.com.ng', 'AWOPEGBA', 'MOYOSORE', '', '9', '28', '19', 'EXECUTIVE TRAINEE'),
('paulinus.babatunde@ensure.com.ng', 'BABATUNDE', 'PAULINUS', '', '10', '32', '19', 'ASSISTANT MANAGER (UNIT HEAD)'),
('funke.ajayi@ensure.com.ng', 'AJAYI', 'OLUWAFUNKE', 'ABOSEDE', '10', '32', '19', 'EXECUTIVE OFFICER'),
('banji.bolaji@ensure.com.ng', 'OLABANJI', 'BOLAJI', '', '10', '32', '19', 'ASSISTANT EXECUTIVE OFFICER'),
('reuben.gold@ensure.com.ng', 'REUBEN', 'GOLD', '', '10', '32', '19', 'CONTRACT'),
('femi.ajeyomi@ensure.com.ng', 'AJEYOMI', 'OLUWAFEMI', 'MICHAEL', '11', '36', '19', 'SENIOR EXECUTIVE OFFICER (UNIT HEAD)'),
('ogechi.ohiagu@ensure.com.ng', 'OGECHI', 'OHIAGU', '', '11', '36', '19', 'EXECUTIVE OFFICER'),
('denden.odjada@ensure.com.ng', 'DENDEN', 'ODJADA', '', '11', '36', '19', 'EXECUTIVE TRAINEE'),
('adeniyi.pitan@ensure.com.ng', 'NIYI', 'PITAN', '', '12', '39', '19', 'MANAGER'),
('oyeleke.oluwole@ensure.com.ng', 'OYELEKE', 'OLUWOLE', '', '12', '39', '19', 'EXECUTIVE TRAINEE'),
('lara.adesuyi@ensure.com.ng', 'OMOWUMI', 'ADESUYI', '', '12', '39', '19', 'EXECUTIVE TRAINEE'),
('lola.adeyemi@ensure.com.ng', 'DAMILOLA', 'ADEYEMI', '', '12', '39', '19', 'CONTRACT'),
('tunji.oshiyoye@ensure.com.ng', 'OYETUNJI', 'OSHIYOYE', '', '13', '43', '43', 'SENIOR MANAGER'),
('seun.osundiran@ensure.com.ng', 'OLUWASEUN', 'OSUNDIRAN', '', '13', '44', '43', 'MANAGER'),
('chinwe.obianyo@ensure.com.ng', 'CHINWE', 'OBIANYO', '', '14', '44', '43', 'EXECUTIVE OFFICER '),
('adaeze.ngoka@ensure.com.ng', 'ADAEZE', 'IFEOMA', 'NGOKA', '14', '44', '43', 'EXECUTIVE TRAINEE'),
('ope.jokanola@ensure.com.ng', 'OPEYEMI', 'JOKANOLA', '', '14', '44', '43', 'EXECUTIVE TRAINEE'),
('lawretta.ogar@ensure.com.ng', 'LAWRETTA', 'OGAR', '', '15', '44', '43', 'SENIOR EXECUTIVE OFFICER'),
('alfred.tabiti@ensure.com.ng', 'ALFRED', 'ADEBAYO', 'TABITI', '15', '49', '43', 'SENIOR EXECUTIVE OFFICER'),
('jehu.maduka@ensure.com.ng', 'JEHU', 'MADUKA', '', '15', '50', '43', 'SENIOR EXECUTIVE OFFICER'),
('emmanuel.nwachukwu@ensure.com.ng', 'EMMANUEL', 'NWACHKWU', '', '15', '51', '43', 'EXECUTIVE OFFICER'),
('vivian.onyeukwu@ensure.com.ng', 'VIVIAN', 'ONYEUKWU', '', '16', '44', '43', 'EXECUTIVE TRAINEE'),
('yisa.ishola@ensure.com.ng', 'YISA', 'ISHOLA', '', '17', '44', '43', 'SENIOR EXECUTIVE OFFICER'),
('edna.ozor@ensure.com.ng', 'EDNA', 'UDOKA', '', '18', '44', '43', 'EXECUTIVE TRAINEE'),
('rakiyat.abubakar@ensure.com.ng', 'RAKIYAT', 'ABUBAKAR', '', '18', '44', '43', 'CONTRACT'),
('peace.madu@ensure.com.ng', 'PEACE', 'MADU', '', '18', '44', '43', 'CONTRACT'),
('joy.okoye@ensure.com.ng', 'JOY', 'OKOYE', '', '18', '44', '43', 'CONTRACT'),
('wale.oyedeji@ensure.com.ng', 'OYEDEJI', 'ODEWALE', '', '19', '44', '43', 'CONTRACT'),
('zim.onyeador@ensure.com.ng', 'ZIMUZO', 'ONYEADOR', '', '20', '44', '43', 'SENIOR EXECUTIVE OFFICER'),
('kanma.ekpe@ensure.com.ng', 'KANMA', 'EKPE', '', '20', '44', '43', 'EXECUTIVE TRAINEE'),
('gbenga.jolayemi@ensure.com.ng', 'GBENGA', 'JOLAYEMI', '', '21', '61', '0', 'ASSISTANT MANAGER'),
('segun.arogundade@ensure.com.ng', 'OLUSEGUN', 'AROGUNDADE', '', '21', '61', '0', 'ASSISTANT EXECUTIVE OFFICER'),
('victor.obetta@ensure.com.ng', 'VICTOR', 'OBETTA', '', '21', '61', '0', 'ASSISTANT EXECUTIVE OFFICER'),
('nnenna.deji-lana@ensure.com.ng', 'NNENNA', 'DEJI-LANA', '', '21', '61', '0', 'EXECUTIVE TRAINEE'),
('seun.babajide@ensure.com.ng', 'OLUWASEUN', 'BABAJIDE', '', '35', '65', '65', 'SENIOR MANAGER'),
('enahoro.ikhidero@ensure.com.ng', 'ENAHORO', 'IKHIDERO', '', '22', '66', '65', 'MANAGER'),
('dapo.odunuga@ensure.com.ng', 'ODUNUGA', 'OLADAPO', '', '22', '66', '65', 'SENIOR EXECUTIVE OFFICER'),
('damola.adeyemi@ensure.com.ng', 'ADEDAMOLA', 'ADEYEMI', '', '22', '66', '65', 'EXECUTIVE OFFICER'),
('ochuko.akparobore@ensure.com.ng', 'OCHUKO', 'AKPAROBORE', '', '22', '66', '65', 'EXECUTIVE TRAINEE'),
('tope.akinsote@ensure.com.ng', 'OLUFEMI', 'TEMITOPE', 'AKINSOTE', '22', '66', '65', 'EXECUTIVE TRAINEE'),
('ife.aboyeji@ensure.com.ng', 'ABOYEJI', 'IFELEKE', '', '23', '71', '65', 'SENIOR EXECUTIVE OFFICER'),
('nike.obaoye@ensure.com.ng', 'OLANIKE', 'OBAOYE', '', '23', '71', '65', 'EXECUTIVE OFFICER'),
('roju.akinbo@ensure.com.ng', 'AKINBO', 'ADEROJU', 'OMOLARA', '23', '71', '65', 'EXECUTIVE TRAINEE'),
('bola.adeogun@ensure.com.ng', 'AYINDE', 'MODINAT', 'OMOBOLANLE', '23', '71', '65', 'CONTRACT'),
('temi.da-alcantra@ensure.com.ng', 'TEMITOPE', 'DA-ALCANTRA', '', '23', '71', '65', 'CONTRACT'),
('doose.igbalagh@ensure.com.ng', 'DOOSE', 'IGBALAGH', '', '23', '71', '65', 'CONTRACT'),
('foluto.oyeleke@ensure.com.ng', 'FOLUTO', 'ADEBAYO', '', '23', '71', '65', 'CONTRACT'),
('joanne.okafor@ensure.com.ng', 'JOANNE', 'CHIOMA', 'OKAFOR', '23', '71', '65', 'CONTRACT'),
('lois.igor@ensure.com.ng', 'LOIS', 'IGOR', '', '23', '71', '65', 'CONTRACT'),
('Hope.Nwokedi@ensure.com.ng', 'HOPE', 'NWOKEDI', '', '23', '71', '65', 'CONTRACT'),
('priye.tamunokuro@ensure.com.ng', 'PRIYE', 'TAMUNOKURO', '', '23', '71', '65', 'CONTRACT'),
('chinyere.ogbonna@ensure.com.ng', 'CHINYERE', 'OGBONNA', '', '23', '71', '65', 'CONTRACT'),
('loving-good.amadi@ensure.com.ng', 'LOVING', 'GOOD', 'AMADI', '23', '71', '65', 'CONTRACT'),
('lovelyn.uche@ensure.com.ng', 'LOVELYN', 'NKIRU', 'UCHE', '23', '71', '65', 'CONTRACT'),
('yinka.akinrimisi@ensure.com.ng', 'YINKA', 'MAUREEN', 'AKINRIMISI', '23', '71', '65', 'CONTRACT'),
('deborah.olaifa@ensure.com.ng', 'DEBORAH', 'OLAIFA', '', '23', '71', '65', 'CONTRACT'),
('kesi.ajaifia@ensure.com.ng', 'KESIENA', 'AJAIFIA', '', '23', '71', '65', 'CONTRACT'),
('ruemu.oghomienor@ensure.com.ng', 'RUEMU', 'OGHOMIENOR', '', '23', '71', '65', 'CONTRACT'),
('adetutu.adebesin@ensure.com.ng', 'ADETUTU', 'ADEBESIN', '', '23', '71', '65', 'CONTRACT'),
('yinka.odiahi@ensure.com.ng', 'OLAYINKA', 'ODIAHI', '', '24', '71', '65', 'CONTRACT'),
('bola.adedugba@ensure.com.ng', 'ADEBOLA', 'ADEDUGBA', '', '24', '71', '65', 'CONTRACT'),
('osogom.odumugbo@ensure.com.ng', 'OSOGOM', 'AKUMAH', '', '24', '71', '65', 'CONTRACT'),
('abiola.adesina@ensure.com.ng', 'ABIOLA', 'ADESINA', '', '24', '71', '65', 'CONTRACT'),
('niran.adeyemi@ensure.com.ng', 'ADENIRAN', 'ADEYEMI', '', '25', '94', '65', 'SENIOR EXECUTIVE OFFICER'),
('ife.oke@ensure.com.ng', 'OKE', 'IFETAYO', '', '25', '94', '65', 'ASSISTANT EXECUTIVE OFFICER'),
('chika.ogbonnaya@ensure.com.ng', 'OGBONNAYA', 'CHIKA', '', '25', '94', '65', 'ASSISTANT EXECUTIVE OFFICER'),
('kazeem.akinoso@ensure.com.ng', 'KAZEEM', 'AKINOSO', '', '25', '94', '65', 'ASSISTANT EXECUTIVE OFFICER'),
('buky.onajobi@ensure.com.ng', 'BUKOLA', 'YETUNDE', 'ONAJOBI', '25', '94', '65', 'EXECUTIVE TRAINEE'),
('ronke.morgan@ensure.com.ng', 'OLARONKE', 'MORGAN', '', '25', '94', '65', 'EXECUTIVE TRAINEE'),
('funmi.badmus@ensure.com.ng', 'OLUWAFUNMILAYO', 'BADMUS', '', '25', '94', '65', 'EXECUTIVE TRAINEE'),
('tope.idowu@ensure.com.ng', 'TEMITOPE', 'IDOWU', '', '25', '94', '65', 'CONTRACT'),
('sopuru.okoli@ensure.com.ng', 'SOPURUCHUKWU', 'OKOLI', '', '25', '94', '65', 'CONTRACT'),
('ogheneochuko.nuabor@ensure.com.ng', 'OGEHENEOCHUKO', 'NUABOR', '', '25', '94', '65', 'CONTRACT'),
('afeez.adegbola@ensure.com.ng', 'AFEEZ', 'ADEGBOLA', '', '25', '94', '65', 'CONTRACT'),
('ore.akintobi@ensure.com.ng', 'ORE', 'AKINTOBI', '', '25', '94', '65', 'EXECUTIVE TRAINEE'),
('sunkanmi.adekeye@ensure.com.ng', 'OLASUNKANMI', 'ADEKEYE', '', '26', '106', '106', 'GENERAL MANAGER'),
('wale.adeneye@ensure.com.ng', 'ADEWALE', 'ADENEYE', '', '26', '107', '106', 'SENIOR MANAGER'),
('samuel.ohonusi@ensure.com.ng', 'SAMUEL', 'OHONUSI', '', '27', '108', '106', 'DEPUTY MANAGER'),
('deji.adeleke@ensure.com.ng', 'ADEDEJI', 'MARTINS', 'ADELEKE', '27', '108', '106', 'ASSISTANT MANAGER'),
('demola.hassan@ensure.com.ng', 'HASSAN', 'ADEMOLA', '', '27', '108', '106', 'ASSISTANT EXECUTIVE OFFICER'),
('itohan.ojo@ensure.com.ng', 'MERCY', 'ITOHAN', '', '27', '108', '106', 'EXECUTIVE TRAINEE'),
('abimbola.komolafe@ensure.com.ng', 'ABIMBOLA', 'KOMOLAFE', '', '27', '108', '106', 'EXECUTIVE TRAINEE'),
('sanmi.fabode@ensure.com.ng', 'OLUSANMI', 'FABODE', '', '27', '108', '106', 'EXECUTIVE TRAINEE'),
('ben.agudosi@ensure.com.ng', 'BENEDICT', 'AGUDOSI', '', '27', '108', '106', 'EXECUTIVE TRAINEE'),
('juliet.okere@ensure.com.ng', 'JULIET', 'OKERE', '', '27', '108', '106', 'EXECUTIVE TRAINEE'),
('temi.oyetunji@ensure.com.ng', 'TEMILOLA', 'KEHINDE', 'OYETUNJI', '27', '108', '106', 'EXECUTIVE TRAINEE'),
('rufina.eze@ensure.com.ng', 'RUFINA', 'CHINASA', 'EZE', '27', '108', '106', 'EXECUTIVE TRAINEE'),
('deinde.gomez@ensure.com.ng', 'GOMEZ,', 'OLADEINDE', 'MAX', '28', '118', '106', 'ASSISTANT MANAGER'),
('rosemarie.uvoh@ensure.com.ng', 'ROSEMARIE', 'UVOH', '', '28', '118', '106', 'EXECUTIVE TRAINEE'),
('seye.ajibulu@ensure.com.ng', 'SEYE', 'AJIBULU', '', '29', '120', '106', 'SENIOR MANAGER'),
('femi.odejobi@ensure.com.ng', 'OLUWAFEMI', 'ODEJOBI', '', '29', '121', '106', 'ASSISTANT MANAGER'),
('doyin.aderinto@ensure.com.ng', 'ADERINTO', 'ADEDOYIN', '', '29', '121', '106', 'EXECUTIVE TRAINEE'),
('funmi.olofintuyi@ensure.com.ng', 'OLUFUNMILAYO', 'OLOFINTUYI', '', '29', '121', '106', 'EXECUTIVE OFFICER'),
('dickson.okorie@ensure.com.ng', 'DICKSON', 'OKORIE', '', '29', '121', '106', 'EXECUTIVE OFFICER'),
('daniel.adebayo@ensure.com.ng', 'ADEBAYO', 'DANIEL', 'TUBOSUN', '29', '121', '106', 'EXECUTIVE TRAINEE'),
('alex.nwaefulu@ensure.com.ng', 'ALEXANDER', 'NWAEFULU', '', '29', '121', '106', 'EXECUTIVE TRAINEE'),
('ife.adeniyi@ensure.com.ng', 'ADENIYI', 'IFEOLUWA', 'SAMUEL', '29', '121', '106', 'EXECUTIVE TRAINEE'),
('nelly.okechukwu@ensure.com.ng', 'OKECHUKWU', 'NELLY', 'EZINNE', '30', '108', '106', 'ASSISTANT EXECUTIVE OFFICER'),
('aima.higo@ensure.com.ng', 'AIMALOHIME', 'HIGO', '', '30', '108', '106', 'EXECUTIVE TRAINEE'),
('kunle.giwa@ensure.com.ng', 'KUNLE', 'GIWA', '', '31', '108', '106', 'EXECUTIVE OFFICER'),
('kindness.mosunmola@ensure.com.ng', 'KINDNESS', 'AKAWE', '', '31', '108', '106', 'EXECUTIVE TRAINEE'),
('gideon.ataraire@ensure.com.ng', 'GIDEON', 'ATARAIRE', '', '32', '132', '132', 'ASSISTANT GENERAL MANAGER'),
('seyi.olajide@ensure.com.ng', 'OLAJIDE', 'OLUWASEYI', 'PETER', '33', '136', '132', 'EXECUTIVE OFFICER'),
('bose.aikhorin@ensure.com.ng', 'AIKHORIN', 'GLORY', 'BOSE', '33', '136', '132', 'ASSISTANT EXECUTIVE OFFICER'),
('mayowa.olugbola@ensure.com.ng', 'MAYOWA', 'OLUGBOLA', '', '33', '136', '132', 'EXECUTIVE TRAINEE'),
('abimbola.anifowose@ensure.com.ng', 'ABIMBOLA', 'ANIFOWOSE', '', '34', '136', '132', 'ASSISTANT MANAGER'),
('akin.akande@ensure.com.ng', 'AKANDE', 'AKINDIJI', '', '34', '136', '132', 'EXECUTIVE OFFICER'),
('linda.brown@ensure.com.ng', 'BROWN', 'BASSEY', 'LINDA', '34', '136', '132', 'CONTRACT'),
('fred.egbe@ensure.com.ng', 'FRED', 'EGBE', '', '34', '136', '132', 'CONTRACT'),
('alex.okolia@ensure.com.ng', 'OKOLIA', 'ALEXANDER', 'CHUKWUGOZAM', '34', '136', '132', 'CONTRACT'),
('celestine.agbudumhe@ensure.com.ng', 'GABRIEL', 'CELESTINE', 'AGBUDUMLU', '34', '136', '132', 'CONTRACT'),
('wale.olubayo@ensure.com.ng', 'ADEWALE', 'OLUBAYO', '', '34', '136', '132', 'CONTRACT'),
('udoka.nwaogbe@ensure.com.ng', 'UDOKA', 'NWAOGBE', '', '34', '136', '132', 'CONTRACT'),
('pere.akpeti@ensure.com.ng', 'PEREWARE', 'AKPETI', '', '35', '144', '132', 'ASSISTANT MANAGER'),
('osaru.enaholo@ensure.com.ng', 'OSARUMWENSE', 'ENAHOLO', '', '35', '144', '132', 'EXECUTIVE OFFICER'),
('jennifer.obulo@ensure.com.ng', 'JENNIFER', 'OBULO', '', '35', '144', '132', 'EXECUTIVE TRAINEE')
...
// inser role
$roleInsert = "INSERT INTO `role` (
 `id`,  `roleName`, `description`, `detail`, created 
  ) 
  VALUES 
  (NULL, 
 'superAdmin', 
 'Supper Admin on the site',
 'Supper Admin',
 '$datenow'
),
 (NULL, 
...
$AdminMenu = '<div class="navbar-default sidebar" role="navigation">
...
<li>
                            <a href="basics.php"><i class="fa fa-gears fa-fw"></i> Core Setup<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Menu.php"> Fleet</a>
                                </li>
                                  <li>
                                    <a href="DriverSatus.php"> Driver</a>
                                </li>
                               
                                <li>
                                    <a href="Fleetstatus.php"> User</a>
                                </li>
                       ...
                       <li>
                            <a href="setup.php"><i class="fa fa-gears fa-fw"></i> Setup<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                ...
                                <li>
                                    <a href="bookingTime.php">Booking Time / Max Booking</a>
                                </li>
                                <li>
                                    <a href="departmentBooking.php">Departmental Booking</a>
                                </li>
			...
			<li>
				...
				<a href="fleet.php"><i class="fa fa-cab fa-fw"></i> Fleet<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="fleet.php"> Fleet</a>
                                </li>
                        ...
                        <li>
                           <a href="account.php"><i class="fa fa-ticket   fa-fw"></i> Acount<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="mydetails.php"> My Detail</a>
                                </li>
                                <li>
                                    <a href="mybookings.php"> My Bookings</a>
                                </li>
								<li>
                                    <a href="authorized.php"> Pending on me</a>
                                </li>
                        ...
                        <li>
                            <a href="report.php"><i class="fa fa-road fa-fw"></i> Reports</a>
                        </li>
                    </ul>
                </div>
	...
	$userMenu = '<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <!--<li class="sidebar-search">
                            <div class="input-group custom-search-form">
	...
	$superUserMenunu ='<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <!--<li class="sidebar-search">
                            <div class="input-group custom-search-form">
   ...
   <li>
                            <a href="setup.php"><i class="fa fa-gears   fa-fw"></i>Core Setup<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
...
$staffMenu = '<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <!--<li class="sidebar-search">
                            <div class="input-group custom-search-form">
...
$menuInsert = "INSERT INTO `menu` (
 `id`,  `roleid`, `detail`, `created` 
  )
  values
  (NULL, '1', '".$AdminMenu."', '$datenow'), (NULL, '2', '".$superUserMenunu."', '$datenow'), (NULL, '3', '".$userMenu."', '$datenow'), (NULL, '4', '".$staffMenu."', '$datenow')";
   

$departmentInsert = "INSERT INTO `department` (
   `department`
  )
...
('I B D'), 
('I B D - FINANCIAL INSTITUTIONS/TELECOMMUNICATIONS/PUBLIC SECTOR'), 
('I B D - MANUFACTURING/FMCG AND CONSTRUCTION'), 
('I B D - TRANSPORTATION/DOWN STREAM'), 
('I B D - ENERGY'), 
('I B D - PUBLIC SECTOR/COMMERCIAL - SOUTH/EAST (PORT HARCOURT)'), 
('I B D - PUBLIC SECTOR/COMMERCIAL - NORTH (ABUJA)'), 
('RETAIL SALES AND MARKETING'), 
('RETAIL SALES AND MARKETING - PARTNERS'), 
('RETAIL SALES AND MARKETING - FINANCIAL ADVISORS AND AGENCY'), 
('RETAIL SALES AND MARKETING - E-CHANNELS'), 
('RETAIL SALES AND MARKETING - SME DESK'), 
('RETAIL SALES AND MARKETING - RENEWALS'), 
('RETAIL SALES AND MARKETING - RETAIL OPERATIONS'), 
('RETAIL SALES AND MARKETING - MARKETING AND CORPORATE COMMUNICATIONS'), 
...
('TECHNICAL/UNDERWRITING - LIFE'), 
('TECHNICAL/UNDERWRITING - CLAIMS '), 
('TECHNICAL/UNDERWRITING - REINSURANCE'), 
('TECHNICAL/UNDERWRITING - ACTUARIAL AND DATA ANALYSIS'), 
...
$locationInsert = "INSERT INTO `location` (
 `id`,  `location`, `created` 
  ...
  values (NULL,'Lagos, Head Office', '$datenow'),
  (NULL,'Lagos, Ikeja', '$datenow'),
  (NULL,'Abuja', '$datenow'),
  (NULL,'Port Harcourt', '$datenow')
  ";
    
   
$fleetStatusInsert = "INSERT INTO `fleetStatus` (
 `id`,  `fleetStatus`, `created` 
  )
  values 
  (NULL,'Available', '$datenow'),
  (NULL,'Faulty', '$datenow'),
  (NULL,'Indispose', '$datenow'),
  (NULL,'Booked', '$datenow')
  
  ";
    
    
$DriverStatusInsert = "INSERT INTO `driverStatus` (
 `id`,  `driverStatus`, `created` 
  )
  values (NULL,'Available', '$datenow'),
  (NULL,'sick', '$datenow'),
  (NULL,'Unavailable', '$datenow'),
  (NULL,'Unemployed', '$datenow')
  ";

    
    
    $fleetInsert="INSERT INTO `ensurefleet`.`fleet` 
    ( `MAKEr`, `MODEL`,`regNo`, `LOCATION`, `YEAR`, `chasisNo`, `engineNo`, `DriverId`,`status`, `color`) 
    VALUES 
    
 ('TOYOTA','COROLLA','LSD 191  DJ','2','2015','AHTBFOJE80003992','2ZRU880812','0','1','Black'),
('TOYOTA','COROLLA','LSD 190 DJ','1','2015','AHTBFOJE600003683','2ZRU867461','0','1','Black'),
('MOTORCYCLE','','DBG 913 QB','1','2015','LBBP5MT00DB407084','QJ164FML36966945','0','1','Black'),
('SUZUKI','INAZUMA','ENSURE 3','4','2015','LC6D111101106114','J508110633','0','1','Black'),
('SUZUKI','INAZUMA','ENSURE 4','3','2015','LC6DC1111011020001','J508103614','0','1','Black'),
('TOYOTA','COROLLA','AGL 968 CY ','1','2014','AHTBFOJE500002055','2ZRU804417','12','1','Black'),
('TOYOTA','COROLLA','AGL 978 CY ','1','2014','AHTBFOJE300002068','2ZRU805320','2','1','Black'),
('TOYOTA','COROLLA','AGL 967 CY','1','2014','AHTBFOJE900002074','2ZRU805791','4','1','Black'),
('TOYOTA','COROLLA','AKD 974 CY','1','2014','AHTBFOJE7000020139','2RU804534','13','1','Black'),
('TOYOTA','COROLLA','AGL 973 CY (RBC 917 ZS) ','3','2014','ATHBFOJE100002151','2ZRU802046','15','1','Black'),
('TOYOTA','COROLLA','AKD 976 CY','3','2014','ATHB0JEX00002P066','2ZRFE1798','0','1','Black'),
('TOYOTA','COROLLA','AGL 976 CY','4','2014','AHTBFOJE700001330','2ZRU796141','0','1','Black'),
('TOYOTA','COROLLA','AGL 974 CY','1','2014','AHTBFOJE100002165','2ZRU801860','6','1','Black'),
('TOYOTA','COROLLA','AKD 973 CY','1','2014','AHTBFOJE800001336','2ZRU796597','15','1','Black'),
('TOYOTA','COROLLA','AGL 972 CY (RBC 918 ZS','3','2014','AHTBFOJE500002105','2RU788074','0','1','Black'),
('TOYOTA','COROLLA','AGL 975 CY','1','2014','AHTBFOJE800002129','2ZU786986','5','1','Black'),
('TOYOTA','COROLLA','LSR 371 CM','1','2013','AHTLC58EX03036104','2ZRU740641','16','1','Black'),
('TOYOTA','COROLLA','LSR 364 CM','1','2013','ATHLC56E803035276','2ZRU703244','14','1','Black'),
('TOYOTA','COROLLA','LSR 368 CM','1','2013','AHTLC58E403036129','2RU741571','7','1','Black'),
('TOYOTA','COROLLA','LSR 369 CM','4','2013','AHTLC56E403035985','2ZRU730246','0','1','Black'),
('TOYOTA','COROLLA','KJA 257 BR ','1','2013','AHTB52E503080829','2ZRU645380','0','1','Black'),
('TOYOTA','COROLLA','LSR 367 CM (RBC 920 ZS)','3','2013','AHTLB52E603082220','1ZRU725260','0','1','Black'),
('TOYOTA','COROLLA','LSR 372 CM','2','2013','AHTLB52E003082911','1ZRU751801','17','1','Black'),
('TOYOTA','COROLLA','LSD 635 CM','4','2013','AHTLC56E003035403','2ZRU714663','0','1','Black'),
('TOYOTA','COROLLA','LSD 637 CM','1','2013','AHTLC58E703036092','2ZRU730727','8','1','Black'),
('TOYOTA','COROLLA','LSD 636 CM','1','2013','ATHLC58E903036286','2ZRU748390','11','1','Black'),
('TOYOTA','COROLLA','LSR 366 CM ','4','2013','AHTLB52E303081946','1ZRU681086','0','1','Black'),
('TOYOTA','COROLLA','LSR 365 CM','1','2013','AHTLC56E303035931','2RU723827','1','1','Black'),
('TOYOTA','HILUX','SMK 256 XA','1','2011','AHTTEX12G809505896','2TR7119025','10','1','Black')


;";
  
$driverInsert = "INSERT INTO `ensurefleet`.`driver` (`fname`, `lname`, `phoneno`,  `status`) 
VALUES ('Francis', 'Eguavon', '08090493945','1'),
('Ikechukwu', 'Onuwuchi', '08037278138','1'),
('Kazeem', 'Ismail', '07062230635','1'),
('Solomon', 'Udokwe', '08090495262','1'),
('Charles', 'Mayaki', '08103233138','1'),
('Abiodun', 'Bello', '08090495265','1'),
('Ahmed', 'Deboss', '08090495268','1'),
('Amedu', 'Godwin', '07031981765','1'),
('Emmanuel', 'Sunday', '07066471661','1'),
('Saturday', 'Williams', '08090495270','1'),
('Itoro', 'Idiang', '08090492712','1'),
('Sule', 'Samuel', '08090213502','1'),
('Uchenna', 'Nnabu', '08090213501','1'),
('Seun', 'Olabode', '09087081567','1'),
('Hassan', 'Baruwa', '08033313971','1'),
('Jamiu', 'Aina', '09087081568','1'),
('Patrick', 'Acha', '09087081563','1'),
('Port-Harcourt', 'Driver', '08090206289','1'),
('Port-Harcourt', 'Driver', '08090206290','1'),
('Port-Harcourt', 'Driver', '08090206291','1'),
('Port-Harcourt', 'Driver', '08090206292','1'),
('Abuja', 'Driver', '08090206293','1'),
('Abuja', 'Driver', '08090206294','1'),
('Abuja', 'Driver', '08090206295','1'),
('Abuja', 'Driver', '08090206296','1')
;";




$stateInsert = "INSERT INTO `state` (`state`, `country`) 
VALUES ('Abia', 'Nigeria'), 
('Adamawa', 'Nigeria'), 
('Anambra', 'Nigeria'), 
('Akwa Ibom', 'Nigeria'), 
...
$shop_basicInsert = "INSERT INTO `shop_basic` (bookingStart, bookingEnd, maxhour,name, cutomer_email,shopDomain,mailClientCust,mailClientIdCust,currency,currencySymbol,smsName) values 
('06:30',
'06:00',
'4',
'Ensure Fleet Manager',
'noreplay@ensure.com.ng',
'fleetmanager.ensure.com.ng',
'external',
'1',
'NGN',
'&#8358;',
...
$shop_ExtMailClientinsert = "INSERT INTO `shop_ExtMailClient` (aliasName,provider, host,port,auth,username,password, SHOP_Id) values 
('Google Mail', 'Gmail', 'ssl://smtp.gmail.com','465','true', 'quotes@ensure.com.ng','ncsarivqnwynsrxa','1')";

$carModelInsertPre ="INSERT INTO fleetmodelYearPre (year, make, fleetmodel) VALUES (1909, 'Ford', 'Model T'),
...
(2013, 'Volvo', 'XC90');";
    ...
    $carModelInsert = "INSERT INTO fleetmodel (make, fleetmodel) select distinct make, fleetmodel from fleetmodelYearPre";

if ($conn->query($googleTable) === TRUE) {
    echo "googleTable Table created successfully<br/>";
} else {
    echo "Error: " .$googleTable . "<br>" . $conn->error."<br/><br/>";
} 

    

$carMakeInsert = "INSERT INTO fleetmake (fleetmake) select distinct make from fleetmodel";
...
if ($conn->query($role) === TRUE) {
    echo "role Table created successfully<br/>";
} else {
    echo "Error: " . $role . "<br>" . $conn->error."<br/><br/>";
}


if ($conn->query($location) === TRUE) {
    echo "locationTable created successfully<br/>";
} else {
    echo "Error: " . $location . "<br>" . $conn->error."<br/><br/>";
}
...
if ($conn->query($menu) === TRUE) {
    ...
    echo "Error: " . $menu . "<br>" . $conn->error."<br/><br/>";
}


if ($conn->query($upload) === TRUE) {
    echo "upload Table created successfully<br/>";
} else {
    echo "Error: " . $upload . "<br>" . $conn->error."<br/><br/>";
}
...
if ($conn->query($department) === TRUE) {
    ...
    echo "Error: " . $department . "<br>" . $conn->error."<br/><br/>";
}




if ($conn->query($fleetStatus) === TRUE) {
    echo "fleetStatus Table created successfully<br/>";
} else {
    echo "Error: " . $fleetStatus . "<br>" . $conn->error."<br/><br/>";
}
 


if ($conn->query($driverStatus) === TRUE) {
    echo "driverStatus Table created successfully<br/>";
} else {
    echo "Error: " . $driverStatus . "<br>" . $conn->error."<br/><br/>";
}
 

if ($conn->query($fleet) === TRUE) {
    echo "fleet Table created successfully<br/>";
} else {
    echo "Error: " . $fleet . "<br>" . $conn->error."<br/><br/>";
}

 
if ($conn->query($fleetHistory) === TRUE) {
    echo "fleetHistory Table created successfully<br/>";
} else {
    echo "Error: " . $fleetHistory . "<br>" . $conn->error."<br/><br/>";
}
   
if ($conn->query($driver) === TRUE) {
    echo "driver Table created successfully<br/>";
} else {
    echo "Error: " . $driver . "<br>" . $conn->error."<br/><br/>";
}    
     
if ($conn->query($driverHistory) === TRUE) {
    echo "driverHistory Table created successfully<br/>";
} else {
    echo "Error: " . $driverHistory . "<br>" . $conn->error."<br/><br/>";
}    
 

     
if ($conn->query($bookinglog) === TRUE) {
    echo "bookinglog Table created successfully<br/>";
} else {
    echo "Error: " . $bookinglog . "<br>" . $conn->error."<br/><br/>";
}    
 
     
if ($conn->query($mycomment) === TRUE) {
    echo "mycomment Table created successfully<br/>";
} else {
    echo "Error: " . $mycomment . "<br>" . $conn->error."<br/><br/>";
}    
     
if ($conn->query($myRating) === TRUE) {
    echo "myRating Table created successfully<br/>";
} else {
    echo "Error: " . $myRating . "<br>" . $conn->error."<br/><br/>";
} 

 
if ($conn->query($shop_basic) === TRUE) {
    echo "shop_basic Table created successfully<br/>";
} else {
    echo "Error: " .$shop_basic . "<br>" . $conn->error."<br/><br/>";
} 

if ($conn->query($shop_ExtMailClient) === TRUE) {
    echo "shop_ExtMailClient Table created successfully<br/>";
} else {
    echo "Error: " .$shop_ExtMailClient . "<br>" . $conn->error."<br/><br/>";
} 


if ($conn->query($carMake) === TRUE) {
    echo "car model Table created successfully<br/>";
} else {
    echo "Error: " .$carMake . "<br>" . $conn->error."<br/><br/>";
} 


if ($conn->query($carModel) === TRUE) {
    echo "car make Table created successfully<br/>";
} else {
    echo "Error: " .$carModel . "<br>" . $conn->error."<br/><br/>";
} 


if ($conn->query($carModelPre) === TRUE) {
    echo "car model pre Table created successfully<br/>";
} else {
    echo "Error: " .$carModel . "<br>" . $conn->error."<br/><br/>";
} 


if ($conn->query($chatlog ) === TRUE) {
    echo "car cartlog Table created successfully<br/>";
} else {
    echo "Error: " .$chatlog. "<br>" . $conn->error."<br/><br/>";
}


if ($conn->query($state ) === TRUE) {
    echo "State Table created successfully<br/>";
} else {
    echo "Error: " .$state. "<br>" . $conn->error."<br/><br/>";
}
...
if ($conn->query($menuInsert) === TRUE) {
     echo "menus  was inserted successfully<br/>";
} else {
    echo "Error: " . $menuInsert. "<br>" . $conn->error."<br/><br/>";
}



if ($conn->query($roleInsert) === TRUE) {
     echo "role  was inserted successfully<br/>";
} else {
    echo "Error: " . $roleInsert. "<br>" . $conn->error."<br/><br/>";
}


 
if ($conn->query($locationInsert) === TRUE) {
     echo "locationInsert was inserted successfully<br/>";
} else {
    echo "Error: " . $locationInsert. "<br>" . $conn->error."<br/><br/>";
}



if ($conn->query($fleetStatusInsert ) === TRUE) {
     echo "fleetStatusInsert  was inserted successfully<br/>";
} else {
    echo "Error: " . $fleetStatusInsert . "<br>" . $conn->error."<br/><br/>";
}

  

  
if ($conn->query($fleetInsert) === TRUE) {
     echo "DriverStatusInsert  was inserted successfully<br/>";
} else {
    echo "Error: " .  $fleetInsert . "<br>" . $conn->error."<br/><br/>";
}
     
 

if ($conn->query($shop_ExtMailClientinsert) === TRUE) {
    echo "shop_ExtMailClientinsert Table inserted successfully<br/>";
} else {
    echo "Error: " .shop_ExtMailClientinsert . "<br>" . $conn->error."<br/><br/>";
} 


 if ($conn->query($carModelInsertPre) === TRUE) {
    echo "fleet ModelinsertPRe Table inserted successfully<br/>";
} else {
    echo "Error: " .$carModelInsert . "<br>" . $conn->error."<br/><br/>";
}


 if ($conn->query($carModelInsert) === TRUE) {
    echo "fleet Modelinsert Table inserted successfully<br/>";
} else {
    echo "Error: " .$carModelInsert . "<br>" . $conn->error."<br/><br/>";
} 


if ($conn->query($carMakeInsert) === TRUE) {
    echo "fleet MakeInsert Table inserted successfully<br/>";
} else {
    echo "Error: " .$carMakeInsert . "<br>" . $conn->error."<br/><br/>";
}
...
if ($conn->query($departmentInsert) === TRUE) {
     echo "departmentInsert  was inserted successfully<br/>";
} else {
    echo "Error: " . $departmentInsert. "<br>" . $conn->error."<br/><br/>";
}
...
if ($conn->query($driverInsert) === TRUE) {
     echo "DriverStatusInsert  was inserted successfully<br/>";
} else {
    echo "Error: " .  $driverInsert . "<br>" . $conn->error."<br/><br/>";
}
...
if ($conn->query($DriverStatusInsert ) === TRUE) {
     echo "DriverStatusInsert  was inserted successfully<br/>";
} else {
    echo "Error: " . $DriverStatusInsert . "<br>" . $conn->error."<br/><br/>";
}
    



 if ($conn->query($insertEnsureUser) === TRUE) {
    echo "fleet insertEnsureUser Table inserted successfully<br/>";
} else {
    echo "Error: " .$insertEnsureUser . "<br>" . $conn->error."<br/><br/>";
}
...
if ($conn->query($shop_basicInsert) === TRUE) {
    echo "shop_basicInsert Table inserted successfully<br/>";
} else {
    echo "Error: " .$shop_basicInsert . "<br>" . $conn->error."<br/><br/>";
}
*/

   
if ($conn->query($stateInsert) === TRUE) {
    echo "state Table inserted successfully<br/>";
} else {
    echo "Error: " .$stateInsert . "<br>" . $conn->error."<br/><br/>";
}
