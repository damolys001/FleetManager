...
if(isset($_REQUEST['user']) && isset($_REQUEST['pass'])) {
	...
	//$number_of_posts = isset($_REQUEST['num']) ? intval($_REQUEST['num']) : 10; //10 is the default
	...
	$user_id = strtolower($_REQUEST['user']); //no default
...
include_once "../reuseable/connect_db_link.php";
	...
	$query = "SELECT id,pic,namef,namel,email,role, status, created FROM user WHERE email = '$user_id' ";  //and  passHash = '$pass1' and passSalt = '$pass2'
