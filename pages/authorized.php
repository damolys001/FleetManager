    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Pending on Me</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
               ...
               <button id="myall" class="btn btn-success btn-xs ">All Request Pending on me</button>
                       <?php if ( ($_SESSION["role"]=="2") || ($_SESSION["role"]=="1") )
                        {
                        ?>
                         <button id="all" class="btn btn-success btn-xs">All Request Today</button>
                        <button id="allall" class="btn btn-success btn-xs">All Request</button>
                        <?php
                        }
                        ?>
                        </div>
           ...
           function loadFleetTable(id) 
{
 ...
 ///////////HANDEL DATA TABLE////////////////
    ...
    //$("#Pending-Booking-Expired").DataTable({responsive: true });
    //Expired
               }); 
        </script>
