...
$id = $_REQUEST["id"];
$queryCheck = "select * from department where id  = '$id'";
		$result = mysqli_query($link,$queryCheck) or die('Errant query:  '.$query);
while($row = mysqli_fetch_assoc($result)) 
		{
			$_SESSION["departmentNameEdit"] = $row["department"];
			$_SESSION["departmentdetailEdit"] = $row["detail"];
            $_SESSION["departmentmaxPerDeptEdit"] = $row["maxPerDept"];
            
			$_SESSION["departmentUpdatingId"] = $row["id"];
            $_SESSION["departmentdescriptionEdit"] = $row["description"];
            //$_SESSION["departmentUpdatingId"]
			}
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-department" href="index-01.html">Ensure Fleet Manager</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                Department Setup <a href="department.php" class="btn btn-success right" style="float:right"><span > Add New</span></a> 
                    <!-- InstanceEndEditable -->
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <input id="name"  value="<?PHP echo $_SESSION["departmentNameEdit"]?>"  class="form-control">
            <span class="input-group-addon alert-danger"></span>
            </div>
            </div> 
                
                <div class="justInput">
            <label > Maximum Booking Allow At a time</label>
            <div class="form-group input-group">
            <span class="input-group-addon alert-danger"></span>
            <input id="maxPerDept" type="number"  value="<?PHP echo $_SESSION["departmentmaxPerDeptEdit"]?>"  class="form-control">
            <span class="input-group-addon alert-danger"></span>
            </div>
            </div> 
                                      
             <div class="justInput">                        
             <label > Description(Main Name)</label>
             <div class="form-group input-group">
            
            <input type="text" id="description" class="form-control" style="width:100%" value ="<?PHP echo $_SESSION["departmentdescriptionEdit"]?>"/>
            ...
            <textarea id="detail" class="form-control" rows="5" style="width:100%"><?PHP echo $_SESSION["departmentdetailEdit"]?></textarea>
            <span class="input-group-addon "></span>
            </div>
            </div> 
               ...
               <div class="col-lg-6">
                  ...
                  <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php $_SESSION["pagename"] = "barndSetup"; include_once '../resource/departmentgetSession.php'?>
                               <div id="divlog">
    ...
    function justDo()
   {
	...
	{	
	update(name,detail,maxPerDept,description);
	}
}
...
function update(name,detail,maxPerDept,description) {
  //swal("hhf2")
        ...
        xmlhttp.onreadystatechange = function() 
		{
			...
			{				
				...
				if( this.responseText == "updated") 
				{
					...
					keeplog("departmentSetup", name + " user was updated. "+ "") ;
				} else if ( this.responseText == "saved") 
				{
					...
					keeplog("departmentSetup",  name  + " was created " + "") ;
				}else if ( this.responseText == "reset") 
				{
					...
					keeplog("departmentSetup",  name+ " user password wes reset " + "") ;
				}
				else 
				{
					swal({ 
       ...
       xmlhttp.open("GET", "../resource/departmentsave.php?name=" + name+"&detail="+detail+"&maxPerDept="+maxPerDept+"&description="+description , true);
        xmlhttp.send();
