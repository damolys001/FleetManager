    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <a href="driver.php">Drivers</a>/ Add Driver
 ...
 $("a.fancybox").fancybox({
  ...
  'padding': 0
	...
	{	
	   ...
	   var myp = "../resource/driverPreImgUpload.php?fName=" + fName+"&driversLicenseNo="+ driversLicenseNo;
		       $.ajax({
            type:"GET",
            url: myp  ,
...
////image save  Ends
	...
	$('#btnSubmit').prop('disabled', true);
		...
		$('#driversLicenseNo').change(function()
        {
            if ($(this).val()=="")
            {
                  $('#saveFleet').prop('disabled', true);
         ...
         function doSave()
   {
	...
	if ( fName =="" || lName  =="" || Oname  =="" || driversLicenseNo  =="" || PhoneNo  =="" ) 
	{
