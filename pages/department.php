<?php include_once "../resource/session.php"; $_SESSION["departmentUpdatingId"] ="" ?>
<!DOCTYPE html>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="form-group input-group">
            <span class="input-group-addon alert-danger"></span>
            <input id="maxPerDept" type="number"  value=""  class="form-control">
            <span class="input-group-addon alert-danger"></span>
            </div>
            </div> 
            ...
            <input id="description" class="form-control" style="width:100%"></input>
            ...
            <textarea id="detail" class="form-control" rows="5" style="width:100%"></textarea>
           <span class="input-group-addon "></span>
            </div>
            </div> 
