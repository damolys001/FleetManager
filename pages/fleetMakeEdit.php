...
$id = $_GET["id"];
$queryCheck = "select * from fleetmake where id  = '$id'";
		$result = mysqli_query($link,$queryCheck) or die('Errant query:  '.$query);
while($row = mysqli_fetch_assoc($result)) 
		{
			$_SESSION["fleetmakeNameEdit"] = $row["fleetmake"];
			$_SESSION["fleetmakedetailEdit"] = $row["detail"];
			$_SESSION["fleetmakeUpdatingId"] = $row["id"];
			}
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-fleetmake" href="index-01.html">Ensure Fleet Manager</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                Fleet Make Setup <a href="fleetmake.php" class="btn btn-success right" style="float:right"><span > Add New</span></a> 
                    <!-- InstanceEndEditable -->
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <input id="name"  value="<?PHP echo $_SESSION["fleetmakeNameEdit"]?>"  class="form-control">
            <span class="input-group-addon alert-danger"></span>
            </div>
            </div> 
            ...
            <textarea id="detail" class="form-control" rows="5" style="width:100%"><?PHP echo $_SESSION["fleetmakedetailEdit"]?></textarea>
               ...
               <div class="col-lg-6">
                  ...
                  <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php $_SESSION["pagename"] = "barndSetup"; include_once '../resource/fleetmakegetSession.php'?>
                               <div id="divlog">
...
function update(name,detail) {
  //swal("hhf2")
        ...
        xmlhttp.onreadystatechange = function() 
		{
			...
			{				
				...
				if( this.responseText == "updated") 
				{
					...
					keeplog("fleetmakeSetup", name + " user was updated. "+ "") ;
				} else if ( this.responseText == "saved") 
				{
					...
					keeplog("fleetmakeSetup",  name  + " was created " + "") ;
				}else if ( this.responseText == "reset") 
				{
					...
					keeplog("fleetmakeSetup",  name+ " user password wes reset " + "") ;
				}
				else 
				{
					swal({ 
       ...
       xmlhttp.open("GET", "../resource/fleetmakesave.php?name=" + name+"&detail="+detail , true);
        xmlhttp.send();
