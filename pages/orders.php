...
<body>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                 ...
                 Order for <input id="datePiker" type="date" style="z-index:10000" ></input> 
  ...
  <!--<span id="divdate"></span>-->
          ...
          <div class="col-lg-6">
           ...
           <tr>
           <td>VAT Rate: </td>
           <td style="padding-right:10px"> <span id="" style=" font-weight:bold"> <?php include_once '../resource/getVat.php'; ?>%</span></td>
           </tr>
           
           <tr>
           <td> Product Price: </td>
           <td style="padding-right:10px"> &#8358;<span id="prodPrice" style=" font-weight:bold"></span> <br/></td>
           </tr>
           <tr>
           
           <td>Total Price: </td>
           <td style="padding-right:10px"> &#8358;<span id="totalPrice" style=" font-weight:bold"></span></td>
           </tr>
           
           <tr>
           <td>VAT Charge: </td>
           <td style="padding-right:10px"> &#8358;<span id="vatCharge" style=" font-weight:bold"></span></td>
           </tr>
           
           <tr>
           <td></td>
           <td style="padding-right:10px"> &#8358;<span id="totalCost" style=" font-weight:bold">0</span> </td>
           </tr>
          ...
          <div class="col-lg-6">
                       <label for="">Product</label>
						<div class="form-group input-group">
                             ...
                             <option></option>
                             <?php include_once '../resource/productGetAll.php'; ?>
                    ...
                    <label for="">Quantity</label>
						<div class="form-group input-group">
							<span class="input-group-addon alert-danger"></span>
                            <input id="myQuantity" type="number" min="0"  value=""  class="form-control">
                            <span class="input-group-addon alert-danger"></span>
						</div>
					</div>
			</div><!-- form row -->
