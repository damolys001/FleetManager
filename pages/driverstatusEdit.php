...
$id = $_GET["id"];
$queryCheck = "select * from driverStatus where id  = '$id'";
		$result = mysqli_query($link,$queryCheck) or die('Errant query:  '.$query);
while($row = mysqli_fetch_assoc($result)) 
		{
			$_SESSION["driverStatusNameEdit"] = $row["driverStatus"];
			$_SESSION["driverStatusdetailEdit"] = $row["detail"];
			$_SESSION["driverStatusUpdatingId"] = $row["id"];
			}
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-driverStatus" href="index-01.html">Ensure Fleet Manager</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                Driver Status Setup <a href="driverStatus.php" class="btn btn-success right" style="float:right"><span > Add New</span></a> 
                    <!-- InstanceEndEditable -->
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <input id="name"  value="<?PHP echo $_SESSION["driverStatusNameEdit"]?>"  class="form-control">
            <span class="input-group-addon alert-danger"></span>
            </div>
            </div> 
            ...
            <textarea id="detail" class="form-control" rows="5" style="width:100%"><?PHP echo $_SESSION["driverStatusdetailEdit"]?></textarea>
               ...
               <div class="col-lg-6">
                  ...
                  <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php $_SESSION["pagename"] = "barndSetup"; include_once '../resource/driverStatusgetSession.php'?>
                               <div id="divlog">
    ...
    function justDo()
   {
	...
	{	
        ...
        $.ajax({
            type:"POST",
            url:"../resource/driverStatussave.php",
            ...
            success:function(data)
			{
				...
				swal({ 
					...
					keeplog("driverstatusSetup", name + " user was updated. "+ "") ;
			}
        });
	}
}
