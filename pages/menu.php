<?php include_once "../resource/session.php"; $_SESSION["menuUpdatingId"] =""; if($_SESSION["role"] != "1") { header('Location: index.php');} ?>
<!DOCTYPE html>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <textarea id="detail" class="form-control" rows="20" style="width:100%"></textarea>
...
function update(name,detail) {
  //swal("hhf2")
        ...
        xmlhttp.onreadystatechange = function() 
		{
			...
			{				
				...
				if( this.responseText == "updated") 
				{
					...
					keeplog("menuSetup", name + " user was updated. "+ "") ;
				} else if ( this.responseText == "saved") 
				{
					...
					keeplog("menuSetup",  name  + " was created " + "") ;
				}else if ( this.responseText == "reset") 
				{
					...
					keeplog("menuSetup",  name+ " user password wes reset " + "") ;
				}
				else 
				{
					swal({ 
       ...
       xmlhttp.open("GET", "../resource/menusave.php?name=" + name+"&detail="+detail , true);
        xmlhttp.send();
