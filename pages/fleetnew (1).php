<?php include_once "../resource/session.php"; $_SESSION["uploadid"]= "";$_SESSION["ref"]= ""; $_SESSION["prodid"]= "";$_SESSION["productbrand"]=""; $_SESSION["productcategory"]="" ?>
<!DOCTYPE html>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- InstanceBeginEditable name="PageTitle" --> <a href="productlist.php">Products </a>/ Add product
          </input>
...
#targetLayer{width:100%;text-align:center;}
                ...
                <div class="well"> 
                 ...
                 <!-- row end-->
                  ...
                  <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" checked value="checked" id="ckBoxTax">Charge taxes on this product
                                                </label>
                   </div>
                  </div>
                  </div>
              ...
              <div class="well"><div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="checked" checked id="visibility">Visible
                                                </label>
                                                
              </div></div>
              <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="checked" id="facebook">Facebook
                                                </label>
              </div>
              <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="checked" id="mobile">Mobile App
                                                </label>
              </div>
              <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="checked" checked id="online">Online Store
                                                </label>
              </div>
              
              <div class="alert"> 
                Set Publish Date<br><input id="dateOfPublish" type="date" style="width:200px ; float:left"   value=""  class="form-control">
                <input id="timeOfPublish" type="time"  style="width:100px; float:left" value=""  class="form-control">
                    ...
                    <h4>Organization</h4>
                      ...
                      <div class="col-lg-12 ">
                        ...
                        <select id ="producttype" class="form-control">
                                                    <?php include_once '../resource/tagGetAll.php'; ?>
                          </select>
                      </div>
