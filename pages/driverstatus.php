<?php include_once "../resource/session.php"; $_SESSION["driverstatusUpdatingId"] ="" ?>
<!DOCTYPE html>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-driverstatus" href="index-01.html">driver Manager</a>
            </div>
            <!-- /.navbar-header -->
...
function update(name,detail) {
  //swal("hhf2")
        ...
        xmlhttp.onreadystatechange = function() 
		{
			...
			{				
				...
				} else if ( this.responseText == "saved") 
				{
					...
					keeplog("driverstatusSetup",  name  + " was created " + "") ;
				}else if ( this.responseText == "reset") 
				{
					...
					keeplog("driverstatusSetup",  name+ " user password wes reset " + "") ;
				}
				else 
				{
					swal({ 
       ...
       xmlhttp.open("GET", "../resource/driverstatussave.php?name=" + name+"&detail="+detail , true);
        xmlhttp.send();
