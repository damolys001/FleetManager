            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Fleet Requsition
...
var options = '';
  ...
  function requestData(w, chart){
    $.ajax({
      type: "GET",
      url: "{{url('../resource/fleetGetAllCart.php')}}", // This is the URL to the API
      data: { w: w }
    })
    .done(function( data ) {
        alert (data)
  ...
  var chart = Morris.Line({
    ...
    element: 'line-Cart-week',
    // Set initial data (ideally you would provide an array of default data)
    data: [0,0],
    xkey: 'Day',
    ykeys: ['Unapproved','Approved','Cancelled','Entended'],
       
    labels: ['Unapproved Request','Approved Request','Cancelled Request','Entended Request'],
