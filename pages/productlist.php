...
<body>
   ...
   <!--         <div class="col-lg-6">
            ...
            <div class="btnSmt">
             <button type=" button" id="btnVatSubmit" onClick="justDo()"  value="Save" class="btn btn-primary">Save</button>
                  ...
                  <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php $_SESSION["pagename"] = "productSetup"; include_once '../resource/productgetSession.php'?>
                               <div id="divlog">
			 ...
			 $(document).ready(function() {
    $("a.productid").click(function(event) {
...
function update(name,price) {
  //swal("hhf2")
        ...
        xmlhttp.onreadystatechange = function() 
		{
			...
			{				
				...
				if( this.responseText == "updated") 
				{
					...
					keeplog("productSetup", name + " Product was updated the "  + " price is " + price + "") ;
				} else if ( this.responseText == "saved") 
				{
					...
					keeplog("productSetup", name + " was created as a product and the "  + " price " + price + "") ;
				}
				else 
				{
					swal({ 
       ...
       xmlhttp.open("GET", "../resource/productsave.php?product=" + name+"&price="+price , true);
        xmlhttp.send();
...
function productGetForUpdate(id) {
        ...
        xmlhttp.onreadystatechange = function() 
		{
            ...
            if (this.readyState == 4 && this.status == 200) 
			{	
				document.getElementById("myproduct").value =this.responseText 		
				//swal (this.responseText)
			}
        };
       xmlhttp.open("GET", "../resource/productGetName.php?id=" + id , true);
        xmlhttp.send(); 
        ...
        xmlhttp.onreadystatechange = function() 
		{
            ...
            if (this.readyState == 4 && this.status == 200) 
			{	
				document.getElementById("myprice").value =this.responseText 		
				//swal (this.responseText)
			}
        };
       xmlhttp.open("GET", "../resource/productGetPrice.php?id=" + id , true);
        xmlhttp.send(); 
