...
$id = $_GET["id"];
$queryCheck = "select * from fleetStatus where id  = '$id'";
		$result = mysqli_query($link,$queryCheck) or die('Errant query:  '.$query);
while($row = mysqli_fetch_assoc($result)) 
		{
			$_SESSION["fleetStatusNameEdit"] = $row["fleetStatus"];
			$_SESSION["fleetStatusdetailEdit"] = $row["detail"];
			$_SESSION["fleetStatusUpdatingId"] = $row["id"];
			}
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-fleetStatus" href="index-01.html">Ensure Fleet Manager</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                Fleet Status Setup <a href="fleetStatus.php" class="btn btn-success right" style="float:right"><span > Add New</span></a> 
                    <!-- InstanceEndEditable -->
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <input id="name"  value="<?PHP echo $_SESSION["fleetStatusNameEdit"]?>"  class="form-control">
            <span class="input-group-addon alert-danger"></span>
            </div>
            </div> 
            ...
            <textarea id="detail" class="form-control" rows="5" style="width:100%"><?PHP echo $_SESSION["fleetStatusdetailEdit"]?></textarea>
               ...
               <div class="col-lg-6">
                  ...
                  <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php $_SESSION["pagename"] = "barndSetup"; include_once '../resource/fleetStatusgetSession.php'?>
                               <div id="divlog">
...
function update(name,detail) {
  //swal("hhf2")
        ...
        xmlhttp.onreadystatechange = function() 
		{
			...
			{				
				...
				if( this.responseText == "updated") 
				{
					...
					keeplog("fleetStatusSetup", name + " user was updated. "+ "") ;
				} else if ( this.responseText == "saved") 
				{
					...
					keeplog("fleetStatusSetup",  name  + " was created " + "") ;
				}else if ( this.responseText == "reset") 
				{
					...
					keeplog("fleetStatusSetup",  name+ " user password wes reset " + "") ;
				}
				else 
				{
					swal({ 
       ...
       xmlhttp.open("GET", "../resource/fleetStatussave.php?name=" + name+"&detail="+detail , true);
        xmlhttp.send();
