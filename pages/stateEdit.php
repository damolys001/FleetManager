...
$id = $_GET["id"];
$queryCheck = "select * from state where id  = '$id'";
		$result = mysqli_query($link,$queryCheck) or die('Errant query:  '.$query);
while($row = mysqli_fetch_assoc($result)) 
		{
			$_SESSION["stateNameEdit"] = $row["state"];
			$_SESSION["statedetailEdit"] = $row["detail"];
			$_SESSION["stateUpdatingId"] = $row["id"];
			}
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                State Setup <a href="state.php" class="btn btn-success right" style="float:right"><span > Add New</span></a> 
                    <!-- InstanceEndEditable -->
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <input id="name"  value="<?PHP echo $_SESSION["stateNameEdit"]?>"  class="form-control">
            <span class="input-group-addon alert-danger"></span>
            </div>
            </div> 
            ...
            <textarea id="detail" class="form-control" rows="5" style="width:100%"><?PHP echo $_SESSION["statedetailEdit"]?></textarea>
               ...
               <div class="col-lg-6">
                  ...
                  <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php $_SESSION["pagename"] = "stateSetup"; include_once '../resource/stategetSession.php'?>
                               <div id="divlog">
...
function update(name,detail) {
  //swal("hhf2")
        ...
        xmlhttp.onreadystatechange = function() 
		{
			...
			{				
				...
				if( this.responseText == "updated") 
				{
					...
					keeplog("stateSetup", name + " user was updated. "+ "") ;
				} else if ( this.responseText == "saved") 
				{
					...
					keeplog("stateSetup",  name  + " was created " + "") ;
				}else if ( this.responseText == "reset") 
				{
					...
					keeplog("stateSetup",  name+ " user password wes reset " + "") ;
				}
				else 
				{
					swal({ 
       ...
       xmlhttp.open("GET", "../resource/statesave.php?name=" + name+"&detail="+detail , true);
        xmlhttp.send();
