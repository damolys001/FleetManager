...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="col-lg-6">
             <form role="form">
                  </form>                          <!--<div class="form-group input-group">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <span class="input-group-addon">&#8358;</span>
                          <input id="myrate" type="number" min="0"  value="<?php include_once "../resource/getVat.php" ?>"  class="form-control">
                                            <span class="input-group-addon">%</span>
                                        </div>
                                        <!--<div class="form-group input-group">
                                            <input type="text" class="form-control">
                                         ...
                                         <button type=" button" id="btnVatSubmit" onClick="justDo()" class="btn btn-primary">Save </button>
...
keeplog("vatSetup","VAT rate was change to "+myrate+ "%") ;
getlog(name)
	  }
 ...
 function update(name) {
  ...
  function(){
    window.location.reload() ;
       ...
       xmlhttp.open("GET", "../resource/updatevat.php?myrate=" + name , true);
        xmlhttp.send();
            ...
            <div class="col-lg-6">
             <div class="panel panel-default">
                        <div class="panel-heading">
                            VAT Rate Audit Trail
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <?php $_SESSION["pagename"] = "vatSetup"; include_once '../resource/loggetSession.php'?>
                               <div id="divlog">
                               <!-- <thead>
                                    <tr>
