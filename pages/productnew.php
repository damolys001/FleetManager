<?php include_once "../resource/session.php"; $_SESSION["uploadid"]= "";$_SESSION["ref"]= ""; ?>
<!DOCTYPE html>
<html lang="en">
<!-- InstanceBegin template="/Templates/templateMain.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
<meta charset="utf-8">
...
<title>Taloft CK Order Traking System</title>
<!-- InstanceEndEditable -->
<!-- Bootstrap Core CSS -->
...
<div id="wrapper"> 
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index-01.html">Taloft CK Order Traking System</a> </div>
    <!-- /.navbar-header -->
    ...
    <ul class="nav navbar-top-links navbar-right">
      <!--  <li class="dropdown">
                ...
                <!-- /.dropdown -->
      <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-user fa-fw"></i> <i class="fa fa-caret-down">
        <?php include_once("../resource/getUserName.php")?>
        </i> </a>
        <ul class="dropdown-menu dropdown-user">
          <li><a id="btnProfile" href="#"><i class="fa fa-user fa-fw"></i> User Profile</a> </li>
          <li id="btnSettings"><a href="#"><i class="fa fa-gear fa-fw"></i> Settings</a> </li>
          <li class="divider"></li>
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header"> <!-- InstanceBeginEditable name="PageTitle" --> <a href="productlist.php">Products </a>/ Add product
          </input>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div id="lblmsg" class="panel-heading"> <i class="fa fa-gear fa-fw"></i> Please provide valid inputs </div>
          <div class="panel-body">
            <div class="row"> <!-- InstanceBeginEditable name="MainContent" -->
              <div class="col-lg-8">
                <div class="well ">
                  ...
                  <div class="form-group input-group">
                    <textarea id="description"  value="" rows="5"  class="form-control next-textarea s-none rte-plainview" ></textarea>
                    <span class="input-group-addon "></span> </div>
                </div>
                <div class="well ">
                  <label > Images</label>
...
#targetLayer{width:100%;text-align:center;}
                ...
                <div class="well"> 
                  ...
                  <div class="row">
                    <div class="col-lg-6 ">
                      <label > Price</label>
                        ...
                        <input id="myprice" type="number" min="0"  value=""  class="form-control">
                     ...
                     <div class="form-group input-group">
                      <span class="input-group-addon">&#8358;</span>
                          <input id="mypriceCompare" type="number" min="0"  value=""  class="form-control">
                 ...
                 <!-- row end-->
                  ...
                  <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" id="ckBoxTax">Charge taxes on this product
                                                </label>
                   </div>
                  </div>
                  </div>
                 ...
                 <div class="col-lg-6 ">
                      <label > SKU (Stock Keeping Unit)</label>
                 		<div class="form-group input-group">
                      	<span class="input-group-addon"></span>
                        <input id="sku" type="text"   value=""  class="form-control">
                        <span class="input-group-addon"></span> 
                      </div>
                    </div>
                      <div class="col-lg-6 ">
                     ...
                     <div class="form-group input-group">
                      <span class="input-group-addon"></span>
                          <input id="Barcode" type="text"    value=""  class="form-control">
                       <span class="input-group-addon"></span> </div>
                      </div>
                 </div>    
                ...
                <div class="row">
                 <div class="col-lg-6 ">
                  <label > Quantity</label>
                 		<div class="form-group input-group">
                      	<span class="input-group-addon"></span>
                        <input id="quantity" type="number" min="0"  value=""  class="form-control">
                        <span class="input-group-addon"></span> 
                      </div>
                 </div>    
              ...
              <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" id="mobile">Mobile App
                                                </label>
              </div>
              <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" id="mobile">Online Store
                                                </label>
              </div>
              </div>
              <div class="col-lg-4 well"> 
