...
$id = $_GET["id"];
$queryCheck = "select * from fleetmodel where id  = '$id'";
		$result = mysqli_query($link,$queryCheck) or die('Errant query:  '.$query);
while($row = mysqli_fetch_assoc($result)) 
		{
			$_SESSION["fleetmodelNameEdit"] = $row["fleetmodel"];
			$_SESSION["fleetmodeldetailEdit"] = $row["detail"];
			$_SESSION["fleetmodelUpdatingId"] = $row["id"];
            $_SESSION["productfleetmodel"] = $row["make"];
			}
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-fleetmodel" href="index-01.html">Ensure Fleet Manager</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                Fleet Make Setup <a href="fleetmodel.php" class="btn btn-success right" style="float:right"><span > Add New</span></a> 
                    <!-- InstanceEndEditable -->
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <input id="name"  value="<?PHP echo $_SESSION["fleetmodelNameEdit"]?>"  class="form-control">
            <span class="input-group-addon alert-danger"></span>
            </div>
            </div> 
             ...
             <div class="form-group input-group">
               ...
               <select id="make" class="form-control" >
                ...
                <?PHP //echo $_SESSION["fleetmodeldetailEdit"]?></textarea>
               ...
               <div class="col-lg-6">
                  ...
                  <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php $_SESSION["pagename"] = "barndSetup"; include_once '../resource/fleetmodelgetSession.php'?>
                               <div id="divlog">
    ...
    function justDo()
   {
    ...
    var detail  = $("#make option:selected").val() 
...
function update(name,detail) {
  //swal("hhf2")
        ...
        xmlhttp.onreadystatechange = function() 
		{
			...
			{				
				...
				if( this.responseText == "updated") 
				{
					...
					keeplog("fleetmodelSetup", name + " user was updated. "+ "") ;
				} else if ( this.responseText == "saved") 
				{
					...
					keeplog("fleetmodelSetup",  name  + " was created " + "") ;
				}else if ( this.responseText == "reset") 
				{
					...
					keeplog("fleetmodelSetup",  name+ " user password wes reset " + "") ;
				}
				else 
				{
					swal({ 
       ...
       xmlhttp.open("GET", "../resource/fleetmodelsave.php?name=" + name+"&detail="+detail , true);
        xmlhttp.send();
